...
class playstorescraperWrapper {
    ...
    constructor(options) {
        ...
        this.baseURL = 'https://api.apiverve.com/v1/playstorescraper';
    }
    ...
    async execute(query, callback) {
        ...
        var requiredParams = ["appid", "country"];
...
module.exports = playstorescraperWrapper;
